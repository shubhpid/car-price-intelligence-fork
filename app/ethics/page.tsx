    ...
    <div className="min-h-screen">
      ...
      <div className="border-b border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <p className="text-muted-foreground text-sm max-w-2xl leading-relaxed">
            Vroomly is built on four pillars of responsible AI: Transparency, Accountability, Fairness, and Privacy. Humans remain in the decision loop -- AI provides evidence, not commands.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <p className="text-muted-foreground text-sm mb-6">This is how Vroomly presents AI analysis for human review.</p>
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <p className="text-muted-foreground text-sm mb-5">Vroomly makes no decisions based on who you are -- only on market data about the vehicle.</p>
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 text-center">
          ...
          <p className="text-muted-foreground text-sm max-w-2xl mx-auto">
            Vroomly provides data-driven price intelligence for informational purposes only. Recommendations are generated by machine learning models and AI analysis -- not human financial advice. Always verify with a licensed dealer or independent inspection before purchasing any vehicle.
          </p>
        </div>
      </div>
    </div>
